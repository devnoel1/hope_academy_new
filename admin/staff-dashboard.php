...
$class = $cl['cls_id'];
                      ...
                      <tr>
                          ...
                          <td><?=$view[$s]['gender'];?></td>
                          <td width="20"><a href="staff-dashboard.php?std&single_std=<?=$view[$s]['std_id'];?>" class="btn btn-success"><i class="fa fa-pencil"></i></a></td>
...
<div>             
 ...
 <form method="post" action="process.php?edit_profile&student&sectn=<?=$sec?>&id=<?=$view_st['std_id'];?>&editor=<?php echo 'staff' ?>" enctype="multipart/form-data">
        <?php
            if(isset($_GET['msg'])){
                echo $_GET['msg'];
                $c = $view_st['std_id'];
...
$class = $cl['cls_id'];
                  ...
                  <tr>
                      ...
                      <td align="center"><a href="result.php?std_id=<?=$view[$i]['std_id'];?>&cls=<?=$class;?>&term=<?=$term;?>&ses=<?=$sess_id;?>&sec=<?=$sec;?>&checker=<?php echo "staff";?>" class="btn btn-sm btn-success"><i class="fa fa-eye"></i></a></td>
                  </tr>
                  <?php
                  endfor;
                   }
          ...
          <div class="container">
              ...
              <table class="table table-striped table-bordered" width="50%">
                  ...
                  <tr class="text-uppercase">
                      ...
                      <td width="20"><a class="btn btn-danger" href="process.php?delete&del_as&id=<?=$view['ass_id'];?>&sectn=<?=$sec;?>"><i class="fa fa-trash"></i></a></td>
                  </tr>
                  <?php
                          endwhile;
                  ?>
            ...
            ?>
              ...
              <div class="container" style="width:50%;">
                  <h5>Upload Assignment</h5>
                   ...
                   <?=@$_GET['msg'];?>
                  <form method="post" action="process.php?sectn=<?=$sec;?>&add_as&staff=<?=$user;?>" 
          ...
          <div class="col-md-8">
            <div class="card card-user">
              ...
              <div class="card-body">
                  ...
                  <form method="post" action="process.php?edit_profile&staff&sec=<?=$sec;?>&id=<?=$result['stf_id'];?>">
                  <div class="row">
