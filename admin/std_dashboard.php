    ...
    <body>
        <div class="wrapper">
          ...
          <div class="col-md-8">
           ...
           <form method="post" action="process.php?edit_profile&student&sectn=<?=$sec?>&id=<?=$user_info['std_id'];?>&editor=<?php echo 'std' ?>" enctype="multipart/form-data">
                  <div class="row">
                    ...
                    <div class="col-md-4 pl-1">
                      <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="sname" value="<?=$user_info['surname'];?>" disabled="">
                      </div>
                    </div>
                  </div>
                  <div class="row">
                    <div class="col-md-6 pr-1">
                      <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="mname" value="<?=$user_info['middle_name'];?>" disabled="">
                      </div>
                    </div>
                    <div class="col-md-6 pl-1">
                      <div class="form-group">
                        <label>Other Name</label>
                        <input type="text" class="form-control" name="lname" value="<?=$user_info['other_name'];?>" disabled="">
                      </div>
                    </div>
                  </div>
                  <div class="row">
                    ...
                    <div class="col-md-6">
                      <div class="form-group">
                        <label>Address</label>
                        <input type="text" class="form-control" name="address" value="<?=$user_info['address'];?>" disabled="">
                      </div>
                    </div>
                  </div>
                  <div class="row">
                    <div class="col-md-4 pr-1">
                      <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="state" value="<?=$user_info['soo'];?>" disabled="">
                      </div>
                    </div>
                    <div class="col-md-4 px-1">
                      <div class="form-group">
                        <label>L G A</label>
                        <input type="text" class="form-control" name="lga" value="<?=$user_info['lga'];?>" disabled="">
                      </div>
                    </div>
                      <div class="col-md-4 px-1">
                      <div class="form-group">
                        <label>Date Of Birth</label>
                        <input type="text" class="form-control" name="dob" value="<?=$user_info['dob'];?>" disabled="">
                      </div> 
                    </div>
                  </div>
                   ...
                   <div class="row">
                    <div class="col-md-4 pr-1">
                      <div class="form-group">
                        <label>Age</label>
                        <input type="text" class="form-control" name="age" value="<?=$user_info['cage'];?>" disabled="">
                      </div>
                    </div>
                    <div class="col-md-4 px-1">
                      <div class="form-group">
                        <label>Blood Group</label>
                        <input type="text" class="form-control" name="blood_g" value="<?=$user_info['blg'];?>" disabled="">
                      </div>
                    </div>
                      <div class="col-md-4 px-1">
                      <div class="form-group">
                        <label>Geno Type</label>
                        <input type="text" class="form-control" name="genotype" value="<?=$user_info['gnt'];?>" disabled="">
                      </div>
                    </div>
                  </div>  
                 ...
                 <div class="row">
                    <div class="col-md-4 pr-1">
                      <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="fname" value="<?=$user_info['fan'];?>" disabled="">
                      </div>
                    </div>
                    <div class="col-md-4 px-1">
                      <div class="form-group">
                        <label>Fathers Name</label>
                        <input type="text" class="form-control" name="father_name" value="<?=$user_info['fname'];?>" disabled="">
                      </div>
                    </div>
                      <div class="col-md-4 px-1">
                      <div class="form-group">
                        <label>Mothers Name</label>
                        <input type="text" class="form-control" name="mothers_name" value="<?=$user_info['mname'];?>" disabled="">
                      </div>
                    </div>
                  </div>
                   <div class="row">
                    <div class="col-md-6 pr-1">
                      <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="phone1" value="<?=$user_info['phone1'];?>" disabled="">
                      </div>
                    </div>
                    <div class="col-md-6 px-1">
                      <div class="form-group">
                        <label>Phone Number 2</label>
                        <input type="text" class="form-control" name="phone2" value="<?=$user_info['phone2'];?>" disabled="">
                      </div>
                    </div>
                          ...
                          $class = $user_info['cls_id'];
                            ...
                            if($row > 0){
                                while ($view = mysqli_fetch_array($ass)){
                                    ?>
       <a href="files/<?=$view['files'];?>" class="list-group-item text-capitalize"><?=$view['sub_name'];?></a>
                          <?php
                                }
                            }else{
