...
<body class="" onload="demo.showNotification('top','left')">
  <div class="wrapper ">
    ...
    <div class="main-panel">
      ...
      <div class="content">
       ...
       <div class="container">
              <div class="container">
                  <a href="admin-dashboard.php?std&add_newstd" class="btn btn-success">Register Student  <span><i class="fa fa-user-plus"></i></span></a>
                  <a href="admin-dashboard.php?std&add_returnstd" hidden class="btn btn-danger">Register Returning Student   <span><i class="fa fa-user-plus"></i></span></a>
           ...
           <h5>List Of All Students</h5>
              <div class="table-responsive-sm">
                  <table class="table table-bordered" width="60%" id="dataTable">
                      <tr>
                          <th width="20">SN</th>
                          <th>Reg Number</th>
                          <th>Name</th>
                      ...
                      <tr class="text-capitalize">
                          ...
                          <td class="text-uppercase"><?=$view[$s]['cls_name'];?></td>
                          <td><?=$view[$s]['gender'];?></td>
                          <td width="20"><a href="admin-dashboard.php?std&view_std=<?=$view[$s]['std_id'];?>" class="btn btn-success"><i class="fa fa-pencil"></i></a></td>
                          <td width="20"><a href="process.php?delete&del_student&id=<?=$view[$s]['std_id'];?>&sectn=<?=$sec;?>" class="btn btn-danger"><i class="fa fa-trash"></i></td>
                      </tr>
                      <?php
                        endfor;
                      ?>
                   ...
                   <div class="row">
                      ...
                      endforeach;
                       ...
                       <div class="col-md-6">
                           ...
                           <div class="table-responsive-sm">
                               <table class="table-sm table-bordered" width="100%" id="dataTable">
                                   <tr>
                                        <td>SN</td>
                                        <td>Name</td>
                                    ...
                                    <tr class="text-capitalize">
                                        <td><?=$sno++;?></td>
                                        <td><?=$view[$q]['name'];?></td>
                                        <td><a href="process.php?delete&del_reg=<?=$view[$q]['id'];?>" class="btn btn-sm btn-danger"><i class="fa fa-trash-o"></i></a></td>
                                    </tr>
                                    <?php
                                    endfor;
                                    ?>
          ...
          //teachers
              ...
              $view_st = $handle->fetch("select *,class.cls_id,class.cls_name from student 
                  join class on class.cls_id = student.cls_id
                     where std_id = '$std_id'");
                        ?>
                     <form method="post" action="process.php?edit_profile&student&sectn=<?=$sec?>&id=<?=$view_st['std_id'];?>&editor=<?php echo 'admin' ?>" enctype="multipart/form-data">
        <?php
            if(isset($_GET['msg'])){
                echo $_GET['msg'];
                $c = $view_st['std_id'];
 ...
 <div style="margin-top: -25px;margin-left: 4px; background-color:  green; width: 100px; position:  absolute;">
     ...
     <br/>
        ...
        <div class="row">
                  ...
                  <table class="table " width="60%">
                      ...
                      <tbody>
                         ...
                         <tr class="text-uppercase">
                          ...
                          <td width="20"><a href="process.php?delete&del_staff&id=<?=$view['stf_id'];?>&sectn=<?=$sec;?>" class="btn btn-danger"><i class="fa fa-trash"></i></td>
                      </tr> 
                      <?php
                    endforeach;
                   //     endfor;
          ...
          <div class="container" style="width: 50%">
              <h5>Add Staff</h5>
              <hr/>
              <form method="post" action="process.php?sectn=<?=$sec?>&add_tch">
                  <div class="form-group">
                      <label>Name</label>
         ...
         <?php     
          ...
          <div class="container" style="width: 50%">
              <h5>Add Class</h5>
              <form method="post" action="process.php?sectn=<?=$sec?>&add_cls">
                  <div class="form-group">
          ...
          <div class="container" style="width:50%">
              ...
              <form method="post" action="process.php?sectn=<?=$sec?>&add_ms">
              <?php
              if(isset($_GET['error'])){
        ...
        <?php
                  ...
                  <table class="table table-bordered" width="60%">
                      ...
                      <tbody>
                          ...
                          <tr class="text-uppercase">
                                ...
                                <td width="20"><a href="process.php?delete&del_subject&id=<?=$view['sub_id'];?>&sectn=<?=$sec;?>" class="btn btn-danger"><i class="fa fa-trash"></i></td>
                            </tr>
          ...
          <div class="container" style="width:50%;">
              ...
              <form method="post" action="process.php?sectn=<?=$sec?>&comb_sub">
                  <?php
                    if(isset($_GET['msg'])){
          ...
          <div class="container" style="width:50%">
              ...
              <form method="post" action="process.php?sectn=<?=$sec?>&assign_sub">
                 <?php
                    if(isset($_GET['msg'])){
          ...
          <hr/>
            ...
            <a class=" btn btn-info" href="admin-dashboard.php?calen&new_ses">New Session</a>
              ...
              <?php
             $result = $handle->fetchQuery("select * from act_cal where status = '1' ");
            foreach($result as $v):
           		if($v['term_id'] == "3")
				{?>
                ...
                ?>
                  ...
                  <div class="table-responsive-sm">
                      <table class="table table-bordered">
                          ...
                          <tbody>
                              <?php
                                    $see = $handle->query("select *,acc_session.ses_id,term.term_id
                                     from act_cal
    ...
    //result section
              ...
              <table class="table table-sm table-bordered" width="100%">
                  ...
                  <tbody>
                      ...
                      <tr class="text-capitalize">
                          ...
                          <td><a href="result.php?std_id=<?=$view[$i]['std_id'];?>&cls=<?=$class_id;?>&term=<?=$term;?>&ses=<?=$sess_id;?>&sec=<?=$sec;?>&checker=<?php echo "admin";?>" class="btn btn-sm btn-success"><i class="fa fa-eye"></i></a></td>
                      </tr>
                      <?php
                  endfor;
                      ?>
          ...
          <div class="row">
              <div class="col-md-4">
                  <form method="post" action="process.php?sectn=<?=$sec;?>&cut_off">
                      <?php
                        if(isset($_GET['msg'])){
                            echo $_GET['msg'];
                  ...
                  <div class="table-responsive-sm">
                      <table class="table table-sm table-bordered">
                          ...
                          <tr class="text-capitalize">
                              ...
                              <td><?=$view[$c]['cut_of'];?></td>
                              <td width="5%"><a href="admin-dashboard.php?cut_off&cut_off_edit=<?=$view[$c]['id'];?>" class="btn btn-primary">Edit</a></td>
                          </tr>
                          <?php
                          endfor;
                          ?>
          ...
          <?php
               ...
               ?>
          <form method="post" action="process.php?cut_off_edit=<?=$_GET['cut_off_edit'];?>" style="width: 40%;">
              <div class="form-group">
